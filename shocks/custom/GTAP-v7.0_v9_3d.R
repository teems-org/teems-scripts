...
base_dir <- "~/teems_runs/shocks/custom/dim3"

dim3_shk <- teems_shock(var = "ams",
                        type = "custom",
                        file = "~/src/teems/teems-examples/shock_variations/custom/shocks/ams_3d_full.csv")

closure_specs <- teems_closure(shock = dim3_shk)
...
ams <- teems_parse(cmf_path = cmf_path,
                   type = "variable",
                   name = "ams")
