...
dim2_shk <- teems_shock(var = "pop",
                        type = "custom",
                        file = "~/src/teems/teems-examples/shock_variations/custom/shocks/pop_time_2d_full.csv")

# dim2_shk <- teems_shock(var = "pop",
#                         type = "custom",
#                         file = "~/src/teems/teems-examples/shock_variations/custom/shocks/pop_time_2d_part.csv")
...
pop <- teems_parse(cmf_path = cmf_path,
                   type = "variable",
                   name = "pop")
