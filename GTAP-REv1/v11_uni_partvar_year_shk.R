...
model_name <- "v11_uni_partvar_year_shk"
...
all(variables$dat$aoall[REGr == "asia" & ACTSa == "crops" & Year == 2019]$Value == -3,
    variables$dat$aoall[REGr != "asia" & ACTSa != "crops" & Year != 2019]$Value == 0)
